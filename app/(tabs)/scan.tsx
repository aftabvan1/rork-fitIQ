  ...
  const handleBarcodeScan = async (data: { data: string }) => {
    ...
    try {
      ...
      if (result) {
        ...
        Alert.alert(
          "Product Not Found",
          "We couldn't find this product in our database. The barcode might be invalid or the product isn't in our system yet. Try taking a photo instead.",
          [
      ...
      Alert.alert(
        ...
        [
          { text: "OK", style: "default" },
          { text: "Retry", onPress: () => setScanning(false), style: "default" }
        ]
      );
    } finally {
      setScanning(false);
        ...
        <View style={styles.overlay}>
          ...
          <ThemedText style={styles.instructions}>
            {mode === "barcode" 
              ...
              : "Take a photo of your food for analysis"
            }
          </ThemedText>
        </View>
      </CameraView>
